      ...
      <div className={css.article_banner}>
        ...
        <div className={css.banner_info}>
          <div className={css.banner_left}>
            <p>
              {
                this.props.pageProps.blist && this.props.pageProps.blist.map((item, i) => (
                  <span key={i} style={{color: '#000'}}>{this.props.pageProps.blist.length - 1 == i ? item.title : item.title + ' \\ '}</span>
                ))
              }
            </p>
            <p className={css.tit} style={{color: '#000'}}>{this.props.pageProps.courseInfo.title}</p>
            ...
            <p className={css.info} style={{color: '#000'}}>
              <a href="#">加入购物车</a>
